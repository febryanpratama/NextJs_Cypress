...
function page({}: Props) {
    ...
    async function submitForm(e: SyntheticEvent){
        ...
        // console.log(data)
        let fetch = await AuthRepository.login(data)
        ...
        <div className='w-1/3 h-auto bg-blue-300 text-black rounded-2xl p-4'>
            ...
            <form onSubmit={submitForm}>
                ...
                <div className='flex justify-between items-center mt-4'>
                    ...
                    <Link href='/register' id='registerpage' className='text-sm font-semibold text-blue-500'>Don't have account ? Register</Link>
                </div>
                <button type='submit' className='w-full bg-blue-500 text-white rounded-lg p-2 mt-4'>Login</button>
            </form>
        </div>
    </div>
  )
